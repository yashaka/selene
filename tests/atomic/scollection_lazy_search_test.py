...
def test_scollection_search_is_lazy_and_does_not_start_on_creation():
    GIVEN_PAGE.opened_empty()
    non_existent_collection = ss('.not-existing')
    assert str(non_existent_collection)


def test_scollection_search_is_postponed_until_actual_action_like_questioning_count():
    GIVEN_PAGE.opened_empty()
...
def test_scollection_search_is_updated_on_next_actual_action_like_questioning_count():
    GIVEN_PAGE.opened_empty()
    elements = ss('.will-appear')
